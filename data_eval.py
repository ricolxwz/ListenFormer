...
class VicoDataset(data.Dataset):
    def __init__(self, root, task, dynam_3dmm_transform=None, audio_transform=None):
        ...
        #anno_file = osp.join(self.root, METADATA_DIR, 'test_ood.csv')
        #anno_file = osp.join(self.root, METADATA_DIR, 'neg_train.csv')
        anno_file = osp.join(self.root, METADATA_DIR, 'test_one.csv')
